...
def GetBalanceWalletNoNode(datadir, address):
    _lib.StartTest("Request balance for a wallet "+address)
    res = _lib.ExecuteWallet(['getbalance','-datadir',datadir,"-address",address])
    _lib.FatalAssertSubstr(res,"Balance of","Balance info is not found")
...
def GetWallets(datadir):
    ...
    res = _lib.ExecuteWallet(['listaddresses','-datadir',datadir])
...
def SetNodeConfig(datadir,host,port):
    ...
    res = _lib.ExecuteWallet(['setnode','-datadir',datadir,'-nodehost',host,'-nodeport',port])
...
def GetUnspentNoNode(datadir,address):
    ...
    res = _lib.ExecuteWallet(['showunspent','-datadir',datadir,'-address',address])
...
def GetHistoryNoNode(datadir,address):
    ...
    res = _lib.ExecuteWallet(['showhistory','-datadir',datadir,'-address',address])
