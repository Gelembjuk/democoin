...
func (c AppInput) printUsage() {
	...
	fmt.Println("  listaddressesext - Lists all addresses from the wallet file and show balance for each")
	...
	fmt.Println("  mineblock [-minter ADDRESS] - Try to mine new block if there are enough transactions")
